...
# type
execute run data modify storage fkbm:data cname.type.value set value "Slime"

## rarity/100
# skills
execute if entity @s[tag=fkbm.slime.fusion] run scoreboard players add #rarity fkbm.options 8
execute if entity @s[tag=fkbm.slime.megajump] run scoreboard players add #rarity fkbm.options 12
