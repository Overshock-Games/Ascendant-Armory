## skills
execute if predicate fkbmtool:rng/30 run tag @s add fkbm.vex.dodge
execute if predicate fkbmtool:rng/40 run tag @s add fkbm.vex.axe
...
data merge entity @s {Health:22f}
