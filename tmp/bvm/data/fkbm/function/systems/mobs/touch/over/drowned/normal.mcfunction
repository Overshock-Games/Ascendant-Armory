## skills
execute if predicate fkbmtool:rng/75 run tag @s add fkbm.drowned.hitslow
execute if predicate fkbmtool:rng/50 run tag @s add fkbm.drowned.fireresist
...
execute unless predicate fkbm:mobs/is_baby run attribute @s minecraft:movement_speed modifier add fkbm 0.17 add_value
