...
# type
execute run data modify storage fkbm:data cname.type.value set value "Enderman"
execute if entity @s[tag=fkbm.enderman.vortex,tag=fkbm.affinity.fast] run data modify storage fkbm:data cname.type.value set value "Jumper Enderman"

## rarity/100
# skills
execute if entity @s[tag=fkbm.enderman.lookbreak] run scoreboard players add #rarity fkbm.options 7
execute if entity @s[tag=fkbm.enderman.lookfreeze] run scoreboard players add #rarity fkbm.options 8
execute if entity @s[tag=fkbm.enderman.vortex] run scoreboard players add #rarity fkbm.options 15
