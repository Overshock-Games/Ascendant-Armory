## skills
execute if predicate fkbmtool:rng/10 run tag @s add fkbm.vex.dodge
execute if predicate fkbmtool:rng/20 run tag @s add fkbm.vex.axe
...
#data merge entity @s {Health:14f}
