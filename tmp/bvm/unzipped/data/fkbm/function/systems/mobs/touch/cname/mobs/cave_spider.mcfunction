...
# type
execute run data modify storage fkbm:data cname.type.value set value "Cave Spider"
#execute if entity @s[tag=fkbm.spider.baby] run data modify storage fkbm:data cname.type.value set value "Baby Cave Spider"
#execute if entity @s[tag=fkbm.spider.mommy] run data modify storage fkbm:data cname.type.value set value "Mother Cave Spider"

## rarity/100
# skills
execute if entity @s[tag=fkbm.cavespider.nausea] run scoreboard players add #rarity fkbm.options 5
