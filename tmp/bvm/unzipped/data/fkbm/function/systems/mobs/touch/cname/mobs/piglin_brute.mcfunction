...
# type
execute run data modify storage fkbm:data cname.type.value set value "Piglin Brute"
execute if entity @s[tag=fkbm.piglin_brute.armored,tag=fkbm.piglin_brute.shield] run data modify storage fkbm:data cname.type.value set value "Shelled Piglin Brute"
execute if entity @s[tag=fkbm.piglin_brute.berserk,tag=fkbm.affinity.fast] run data modify storage fkbm:data cname.type.value set value "Skinner Piglin Brute"
