...
# type
execute run data modify storage fkbm:data cname.type.value set value "Wolf"

## rarity/100
# skills
execute if entity @s[tag=fkbm.wolf.angry] run scoreboard players add #rarity fkbm.options 10
