...
execute store result score #tmp2 fkbm.var run data get entity @n[type=minecraft:skeleton,distance=..3] UUID[0]
...
# block arrow
data merge entity @s {Tags:["fkbm.skeleton.blocked"],Motion:[0d,0d,0d],damage:0d}
