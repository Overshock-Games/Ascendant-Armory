...
# type
execute run data modify storage fkbm:data cname.type.value set value "Creeper"
execute if entity @s[tag=fkbm.creeper.bait,tag=fkbm.creeper.baby,tag=fkbm.affinity.fast] run data modify storage fkbm:data cname.type.value set value "Sneaky Creeper"
execute if entity @s[tag=fkbm.creeper.unstable,tag=fkbm.creeper.powered] run data modify storage fkbm:data cname.type.value set value "Unstable Creeper"

## rarity/100
# skills
execute if entity @s[tag=fkbm.creeper.bait] run scoreboard players add #rarity fkbm.options 5
execute if entity @s[tag=fkbm.creeper.baby] run scoreboard players add #rarity fkbm.options 15
execute if entity @s[tag=fkbm.creeper.unstable] run scoreboard players add #rarity fkbm.options 20
