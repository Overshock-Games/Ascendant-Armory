## skills
execute if predicate fkbmtool:rng/50 run tag @s add fkbm.spider.cobweb
execute if predicate fkbmtool:rng/30 run tag @s add fkbm.spider.stickypath
execute if predicate fkbmtool:rng/20 run tag @s add fkbm.spider.mommy
execute if predicate fkbmtool:rng/05 run tag @s add fkbm.spider.cocoon
