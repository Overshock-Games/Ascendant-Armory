scoreboard players set BaseDifficulty fkbm.options 1
scoreboard players set MobModifyFrequency fkbm.options 5
scoreboard players set MobModifyPercent fkbm.options 100
scoreboard players set MobModifyRadius fkbm.options 80
scoreboard players set MobModifyCount fkbm.options 8
scoreboard players set BabyMobModifyFrequency fkbm.options 120
scoreboard players set MobGameplayLatency fkbm.options 1
scoreboard players set MobGriefing.Enable fkbm.options 3
...
data modify storage fkbm:data cname.type.color set value "white"
data modify storage fkbm:data cname.type.prefix set value '{"text":"","color":"gray"}'
data modify storage fkbm:data cname.type.postfix set value '{"text":"","color":"gray"}'
scoreboard players set Cname.affinity fkbm.options 1
data modify storage fkbm:data cname.affinity.prefix set value '{"text":"","color":"gray"}'
data modify storage fkbm:data cname.affinity.postfix set value '{"text":" ","color":"gray"}'
data modify storage fkbm:data cname.affinity.0 set value '{"text":"Weak","color":"white"}'
data modify storage fkbm:data cname.affinity.1 set value '{"text":"Alpha","color":"white"}'
data modify storage fkbm:data cname.affinity.2 set value '{"text":"Healthy","color":"white"}'
data modify storage fkbm:data cname.affinity.3 set value '{"text":"Resistant","color":"white"}'
data modify storage fkbm:data cname.affinity.4 set value '{"text":"Heavy","color":"white"}'
data modify storage fkbm:data cname.affinity.5 set value '{"text":"Strong","color":"white"}'
data modify storage fkbm:data cname.affinity.6 set value '{"text":"Fast","color":"white"}'
scoreboard players set Cname.rarity fkbm.options 1
scoreboard players set Cname.rarity.style fkbm.options 2
data modify storage fkbm:data cname.rarity.prefix set value '{"text":"[","color":"gray"}'
data modify storage fkbm:data cname.rarity.postfix set value '{"text":"] ","color":"gray"}'
data modify storage fkbm:data cname.rarity.11 set value '{"text":"Common","color":"green"}'
data modify storage fkbm:data cname.rarity.12 set value '{"text":"Uncommon","color":"aqua"}'
data modify storage fkbm:data cname.rarity.13 set value '{"text":"Rare","color":"light_purple"}'
data modify storage fkbm:data cname.rarity.14 set value '{"text":"Epic","color":"yellow"}'
data modify storage fkbm:data cname.rarity.15 set value '{"text":"Legendary","color":"#ff5145"}'
data modify storage fkbm:data cname.rarity.21 set value '{"text":"★☆☆☆☆","color":"green"}'
data modify storage fkbm:data cname.rarity.22 set value '{"text":"★★☆☆☆","color":"aqua"}'
data modify storage fkbm:data cname.rarity.23 set value '{"text":"★★★☆☆","color":"light_purple"}'
data modify storage fkbm:data cname.rarity.24 set value '{"text":"★★★★☆","color":"yellow"}'
data modify storage fkbm:data cname.rarity.25 set value '{"text":"★★★★★","color":"#ff5145"}'
data modify storage fkbm:data cname.rarity.31 set value '{"text":"☠∙∙∙∙","color":"green"}'
data modify storage fkbm:data cname.rarity.32 set value '{"text":"☠☠∙∙∙","color":"aqua"}'
data modify storage fkbm:data cname.rarity.33 set value '{"text":"☠☠☠∙∙","color":"light_purple"}'
data modify storage fkbm:data cname.rarity.34 set value '{"text":"☠☠☠☠∙","color":"yellow"}'
data modify storage fkbm:data cname.rarity.35 set value '{"text":"☠☠☠☠☠","color":"#ff5145"}'
scoreboard players set Cname.nightmare fkbm.options 1
scoreboard players set Cname.nightmare.style fkbm.options 1
data modify storage fkbm:data cname.nightmare.prefix set value '{"text":" (","color":"gray"}'
data modify storage fkbm:data cname.nightmare.postfix set value '{"text":") ","color":"gray"}'
data modify storage fkbm:data cname.nightmare.color set value 'gray'
data modify storage fkbm:data cname.nightmare.1 set value '{"text":"☠","color":"gray"}'
data modify storage fkbm:data cname.nightmare.2 set value '{"text":"☽","color":"gray"}'
data modify storage fkbm:data cname.nightmare.3 set value '{"text":"☆","color":"gray"}'
data modify storage fkbm:data cname.nightmare.4 set value '{"text":"nightmare ","color":"gray"}'
...
scoreboard players set Totem.Particle.Show fkbm.options 1
data modify storage fkbm:data totem.particle set value 'minecraft:soul'
...
scoreboard players set BoggedTouch fkbm.options 1
scoreboard players set BoggedInForest fkbm.options 10
scoreboard players set BoggedBreakTorch fkbm.options 1
scoreboard players set BoggedFireResistance fkbm.options 1
scoreboard players set BoggedInfested fkbm.options 1
scoreboard players set BoggedPoisonLeak fkbm.options 1
scoreboard players set BoggedSummoner fkbm.options 1
scoreboard players set BoggedSummonCd fkbm.options 20
scoreboard players set BoggedSword fkbm.options 1
scoreboard players set BoggedSpear fkbm.options 1
scoreboard players set BoggedArmored fkbm.options 1
scoreboard players set BoggedShield fkbm.options 1
scoreboard players set BoggedArrowBlockCd fkbm.options 1
scoreboard players set Bogged.Alpha fkbm.options 1
...
scoreboard players set EvokerRootCd fkbm.options 8
...
scoreboard players set HoglinRegen fkbm.options 1
...
scoreboard players set IllusionerSpawnChance fkbm.options 8
...
scoreboard players set SlimeMegaJump fkbm.options 1
scoreboard players set SlimeMegaJumpCd fkbm.options 10
...
scoreboard players set SkeletonSpear fkbm.options 1
...
scoreboard players set SpiderMommyAggroBabies fkbm.options 1
scoreboard players set SpiderMommyAggroBabiesCd fkbm.options 15
...
scoreboard players set StrayFrozenThornsCd fkbm.options 5
...
scoreboard players set VexDualSword fkbm.options 1
...
scoreboard players set VindicatorRageCd fkbm.options 15
...
scoreboard players set WitherSkeletonBow fkbm.options 1
...
tellraw @s ["",{"storage":"fkbm:text","nbt":"project.print","interpret":true},{"text":"Options have been reset","color":"red"}]
